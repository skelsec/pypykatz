...
Take care, that the github master version might fail because I'm too lazy to do a proper branch for the new versions. I'll try to create a branch of stable version tho.  
...
This is just a basic stuff really. Reason is there that I hate to constantly use psexec to get a system shell from admin...  
